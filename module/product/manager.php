  ...
  // ============================ 新增 =========================
	...
	$param=array(  'Tb_index'=>$Tb_index,
		          ...
		          'aFormat'=>$_POST['aFormat'],
		               'aPic'=>$aPic,
		             'HotPro'=>$HotPro,
	     'activityPrice_name'=>$_POST['activityPrice_name'],
		              'price'=>$_POST['price'],
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
				 ...
				 ?>
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="activityPrice_name">活動價格名稱</label>
							<div class="col-md-4">
								<input type="text" class="form-control" id="activityPrice_name" name="activityPrice_name" value="<?php echo $row['activityPrice_name'];?>" placeholder="預設為會員價">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-md-2 control-label" for="mem_price"><?php echo $active_name =empty($row['activityPrice_name']) ? '會員價' : $row['activityPrice_name'] ;?></label>
							<div class="col-md-4">
...
<script type="text/javascript">
    ...
    //------------------------------ 刪檔 ---------------------------------
     ...
     //----------------------------- 更改活動價格名稱 -------------------------------
       $('#activityPrice_name').change(function(event) {
       	 if ($(this).val()=='') {
            $('[for="mem_price"]').html('會員價');
       	 }else{
       	 	$('[for="mem_price"]').html($(this).val());
       	 }
       });
      });
</script>
